...
<body>
	<%
		...
		String numberring = request.getParameter("numberring");
		System.out.print(numberring);
...
</svg>&nbsp MOMENT WRITE</h2>
                  <span>mission : TRUE BLUE SKY</span>
						
						<%} else if(numberring.equals("3")) {%>
...
<						<%} %>
				...
				<div class="row" style="display: block;">
					<form name="form" method="post" action="WriteService"
							...
							<tbody>
								...
								<tr>
									<td colspan="7"><textarea class="form-control"
											placeholder="글 내용" name="m_article_content" maxlength="2048"
											style="height: 350px;"></textarea></td>
								</tr>

								<tr>
									<td><input type="file" class="m_article_img"
										name="m_article_img" onchange="readURL(this)"></td>
