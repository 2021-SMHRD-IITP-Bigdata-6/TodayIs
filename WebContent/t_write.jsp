			...
			<div class="row">
				...
				<div class="col-md-8 col-sm-8 sort">
					...
					<select name="article-sort" id="inputArticle-Sort" class="">
						<option value="">메인 게시판</option>
						<option value="">미션 게시판</option>
					</select>
				</div>
			</div>
			<div class="row">
				<form name="form" method="post" action="WriteService">
					<table class="table table-striped"
						...
						<tbody>
							<tr>
								...
								<td> <span id = "region" name="m_article_region" class="form-control" ></span> </td>
					...
					<table>
					<tr>
			  		  <td><input type="file" name="m_article_img">
