...
<div class="tm-page-wrap mx-auto">
   <div class="position-relative">
      ...
      <!-- 배너 사진 -->      
      <div class="tm-welcome-container tm-fixed-header tm-fixed-header-2"  style="height:160px;">
         <!--
...
<div class="layer">          
   ...
   <input type="text" name="mb_phone"  class="input-field" placeholder="Your phone number" required>
						...
						<select id="big" name="h_area1" onChange="cat1_change(this.value,h_area2)" class="h_area1">                          					
										    <option>-선택-</option>											
