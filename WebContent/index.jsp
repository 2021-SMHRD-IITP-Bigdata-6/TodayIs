...
<meta name="viewport" content="width=device-width, initial-scale=1.0" />
    ...
    <link rel="stylesheet" href="main_css/templatemo-video-catalog.css" />
    <!--
...
<!-- 날씨 전달 확인중 -->
<script>
console.log(if(dto != null){
	move_dao.Move(dto.getMb_region()).getW_status());
});
</script>
